...
Use the `/oj_tools/acmoj_client.py` script to submit code to ACMOJ, query submission status, or abort pending submissions.

**Please check the `/oj_tools/acmoj_client.py` script file directly for detailed usage instructions and available commands.**
...
- The experimental budget counts every created submission, including one that is later aborted
